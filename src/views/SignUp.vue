<template>
    <div id="login" class="login" style="opacity: 1; display: block; transform: translateY(0px);">
        ...
        <div class="login-form">
            <div class="username-row row" style="opacity: 1; display: block; transform: translateX(0px);">
          ...
          C-191.3,356.5-196.9,350.3-203.7,350.3L-203.7,350.3z"></path>
        </svg>
                </label>
                <input v-model="uname" type="text" id="username_input" class="username-input" placeholder="用户名">
            </div>
            <div class="password-row row" style="opacity: 1; display: block; transform: translateX(0px);">
          ...
          l1.6-6.7l7.1-0.3l0.6-7.2l7.2-6.6c2.8,1.3,5.8,2,9.1,2c11.9,0,21.6-9.7,21.6-21.6C-169.9,357.4-179.6,347.8-191.5,347.8z"></path>
                    </svg>
                </label>
                <input v-model="upwd" type="password" id="password_input" class="password-input" placeholder="密码">
            </div>
            <div class="password-row row" style="opacity: 1; display: block; transform: translateX(0px);">
                <label for="pwdcheck_input">
                    <svg t="1535383217286" class="password-icon" style="" viewBox="0 0 1024 1424" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1846" xmlns:xlink="http://www.w3.org/1999/xlink" height="36px" width="30px">
                        <path d="M788.36 960H235.64A75.66 75.66 0 0 1 160 884.5V592a16 16 0 0 1 32 0v292.5A43.62 43.62 0 0 0 235.64 928h552.72A43.62 43.62 0 0 0 832 884.5v-361A43.62 43.62 0 0 0 788.36 480H235.64A43.62 43.62 0 0 0 192 523.5a16 16 0 0 1-32 0A75.66 75.66 0 0 1 235.64 448h552.72A75.66 75.66 0 0 1 864 523.5v361A75.66 75.66 0 0 1 788.36 960z" fill="#ffffff" p-id="1847"></path>
                        <path d="M752 456a16 16 0 0 1-16-16v-150c0-106.98-93.76-194-209-194h-30C381.76 96 288 183.02 288 290v150a16 16 0 0 1-32 0v-150c0-124.62 108.12-226 241-226h30C659.88 64 768 165.38 768 290v150a16 16 0 0 1-16 16zM455.26 792a80.28 80.28 0 0 1-40.84-11.06 16.12 16.12 0 0 1-1.62-1.08l-86.56-66.52a16 16 0 0 1 19.52-25.34l85.72 65.88c17.38 9.8 40.4 7.62 55.06-5.32L677.42 580a16 16 0 1 1 21.18 24l-190.88 168.52a79.26 79.26 0 0 1-52.46 19.48z" fill="#ffffff" p-id="1848"></path>
                    </svg>
                </label>
                <input v-model="pwdcheck" type="password" id="pwdcheck_input" class="password-input" placeholder="确认密码">
            </div>
            <div class="password-row row" style="opacity: 1; display: block; transform: translateX(0px);">
                <label for="pwdcheck_input">
                    <svg class="password-icon" version="1.1" viewBox="0 0 1300 1500" xmlns="http://www.w3.org/2000/svg" p-id="5636" height="36px" width="30px"><path d="M972.8 934.274509 998.4 908.54902 127.868001 908.54902C85.502225 908.54902 51.2 874.019706 51.2 831.263017L51.2 111.058823 25.6 136.784314 896.131998 136.784314C938.452011 136.784314 972.8 171.324278 972.8 213.860934L972.8 278.566694C972.8 292.77449 984.26151 304.292183 998.4 304.292183 1012.53849 304.292183 1024 292.77449 1024 278.566694L1024 213.860934C1024 142.916556 966.736828 85.333333 896.131998 85.333333L25.6 85.333333 0 85.333333 0 111.058823 0 831.263017C0 902.415639 57.205646 960 127.868001 960L998.4 960 1024 960 1024 934.274509 1024 457.69849C1024 443.490694 1012.53849 431.973001 998.4 431.973001 984.26151 431.973001 972.8 443.490694 972.8 457.69849L972.8 934.274509ZM512.651558 567.164817C520.64791 572.874498 531.187889 573.490406 539.788919 568.750601L1002.624789 313.693694C1015.021598 306.862133 1019.560139 291.225196 1012.761901 278.767619 1005.963665 266.310041 990.403006 261.749254 978.006197 268.580816L515.170327 523.637722 542.307689 525.223505 194.028065 276.539467C182.502788 268.310009 166.520953 271.027598 158.331639 282.609372 150.142325 294.191146 152.846657 310.251322 164.371935 318.480781L512.651558 567.164817Z" p-id="5637" fill="#ffffff"></path></svg>
                </label>
                <input v-model="email" type="text" id="email_input" class="password-input" placeholder="邮箱">
            </div>
            <div class="password-row row" style="opacity: 1; display: block; transform: translateX(0px);">
                <label for="pwdcheck_input">
                    <svg t="1535382867544" class="password-icon" style="" viewBox="0 0 1124 1424" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1053" xmlns:xlink="http://www.w3.org/1999/xlink" height="36px" width="30px">
                        <path d="M242.526316 53.894737v866.681263h530.647579V53.894737H242.526316z m0-53.894737h530.647579a53.894737 53.894737 0 0 1 53.894737 53.894737v866.681263a53.894737 53.894737 0 0 1-53.894737 53.894737H242.526316a53.894737 53.894737 0 0 1-53.894737-53.894737V53.894737a53.894737 53.894737 0 0 1 53.894737-53.894737z" fill="#ffffff" p-id="1054"></path>
                        <path d="M242.526316 727.578947h538.947368v-53.894736H242.526316z" fill="#ffffff" p-id="1055"></path>
                        <path d="M512 824.589474m-53.894737 0a53.894737 53.894737 0 1 0 107.789474 0 53.894737 53.894737 0 1 0-107.789474 0Z" fill="#ffffff" p-id="1056"></path>
                    </svg>
                </label>
                <input v-model="phone" type="text" id="phone_input" class="password-input" placeholder="手机号码">
            </div>
        </div>
        <div class="call-to-action">
            <button @click="signup" id="signup" type="button">注册</button>
            <p>已有账号? <router-link to="/user/login">去登录</router-link></p>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            signup() {
                ...
                var url = `http://127.0.0.1:3000/signup?uname=${this.uname}&upwd=${this.upwd}&email=${this.email}&phone=${this.phone}`;
                if(reg.test(this.uname) && reg.test(this.upwd) && regEmail.test(this.email) && regphone.test(this.phone))
                    axios.get(url).then((reg) => {
                        console.log(reg.data.msg.affectedRows);
                    })
            }
        }
    }
...
<style scoped>
    ...
    .user-icon .user-path{
        ...
        -webkit-animation: dash 3ms linear forwards;
        animation: dash 3ms linear forwards;
    }
